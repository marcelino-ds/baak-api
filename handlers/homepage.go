...
func HandlerHomepage(w http.ResponseWriter, r *http.Request) {
	...
	endpoints := []string{
		...
		"/cariKelasBaru?tipeKelasBaru={Kelas/NPM/Nama}&teks={query}",
		"/cariMhsBaru?tipeMhsBaru={Kelas/Nama}&teks={query}",
		"/uas/{kelas}", "/mata-kuliah", "/dosen-wali/{tingkat}",
		"/koordinator", "/pembimbing-pi", "/panduan-kuliah", "/jadwal-ujian", "/ujian-bentrok",
